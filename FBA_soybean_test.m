...
writetable(struct2table(outFVA),'photon_0_WR1_C1-C2_FVA_beforeRS.csv');
...
outFVA.fluxSpan = outFVA.maxFlux - outFVA.minFlux;
outFVA.rxns     = model.rxns;
writetable(struct2table(outFVA),'photon_0_WR1_C1-C2_FVA_afterRS.csv');
...
outFVA.fluxSpan = outFVA.maxFlux - outFVA.minFlux;
outFVA.rxns     = model.rxns;
writetable(struct2table(outFVA),'photon_0_WR2_C1-C2_FVA_beforeRS.csv');
...
outFVA.fluxSpan = outFVA.maxFlux - outFVA.minFlux;
outFVA.rxns     = model.rxns;
writetable(struct2table(outFVA),'photon_0_WR2_C1-C2_FVA_afterRS.csv');
...
outFVA.fluxSpan = outFVA.maxFlux - outFVA.minFlux;
outFVA.rxns     = model.rxns;
writetable(struct2table(outFVA),'photon_0_WR3_C1-C2_FVA_beforeRS.csv');
%% Running sampling
% Adding a variation =10% of the exchanges rxns within each model
...
outFVA.fluxSpan = outFVA.maxFlux - outFVA.minFlux;
outFVA.rxns     = model.rxns;
writetable(struct2table(outFVA),'photon_0_WR3_C1-C2_FVA_afterRS.csv');
...
outFVA.fluxSpan = outFVA.maxFlux - outFVA.minFlux;
outFVA.rxns     = model.rxns;
writetable(struct2table(outFVA),'photon_0_WR4_C1-C2_FVA_beforeRS.csv');
...
outFVA.fluxSpan = outFVA.maxFlux - outFVA.minFlux;
outFVA.rxns     = model.rxns;
writetable(struct2table(outFVA),'photon_0_WR4_C1-C2_FVA_afterRS.csv');
...
outFVA.fluxSpan = outFVA.maxFlux - outFVA.minFlux;
outFVA.rxns     = model.rxns;
writetable(struct2table(outFVA),'photon_0_WR1_C2-C3_FVA_beforeRS.csv');
...
outFVA.fluxSpan = outFVA.maxFlux - outFVA.minFlux;
outFVA.rxns     = model.rxns;
writetable(struct2table(outFVA),'photon_0_WR1_C2-C3_FVA_afterRS.csv');
...
outFVA.fluxSpan = outFVA.maxFlux - outFVA.minFlux;
outFVA.rxns     = model.rxns;
writetable(struct2table(outFVA),'photon_0_WR2_C2-C3_FVA_beforeRS.csv');
...
outFVA.fluxSpan = outFVA.maxFlux - outFVA.minFlux;
outFVA.rxns     = model.rxns;
writetable(struct2table(outFVA),'photon_0_WR2_C2-C3_FVA_afterRS.csv');
...
outFVA.fluxSpan = outFVA.maxFlux - outFVA.minFlux;
outFVA.rxns     = model.rxns;
writetable(struct2table(outFVA),'photon_0_WR3_C2-C3_FVA_beforeRS.csv');
...
outFVA.fluxSpan = outFVA.maxFlux - outFVA.minFlux;
outFVA.rxns     = model.rxns;
writetable(struct2table(outFVA),'photon_0_WR3_C2-C3_FVA_afterRS.csv');
...
outFVA.fluxSpan = outFVA.maxFlux - outFVA.minFlux;
outFVA.rxns     = model.rxns;
writetable(struct2table(outFVA),'photon_0_WR4_C2-C3_FVA_beforeRS.csv');
%% Running sampling
% Adding a variation =10% of the exchanges rxns within each model
...
outFVA.fluxSpan = outFVA.maxFlux - outFVA.minFlux;
outFVA.rxns     = model.rxns;
writetable(struct2table(outFVA),'photon_0_WR4_C2-C3_FVA_afterRS.csv');
