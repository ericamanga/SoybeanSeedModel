...
printFluxes(model, sol.x,false,'',[root '/outputs/FBA_photon_0_WR1_C1-C2_MaintX10.txt']);
printFluxes(model, sol.x,true,'',[root '/outputs/FBA_photon_0_WR1_C1-C2_toSampl_MainX10.txt']);
...
sol=solveLP(model,1);
printFluxes(model,sol.x, true)
printFluxes(model, sol.x,false,'',[root '/outputs/FBA_photon_0_WR2_C1-C2_maintX10.txt']);
printFluxes(model, sol.x,true,'',[root '/outputs/FBA_photon_0_WR2_C1-C2_toSampl_maintX10.txt']);
...
sol=solveLP(model,1);
printFluxes(model,sol.x, true)
printFluxes(model, sol.x,false,'',[root '/outputs/FBA_photon_0_WR3_C1-C2_maintX10.txt']);
printFluxes(model, sol.x,true,'',[root '/outputs/FBA_photon_0_WR3_C1-C2_toSampl_maintX10.txt']);
...
sol=solveLP(model,1);
printFluxes(model,sol.x, true)
printFluxes(model, sol.x,false,'',[root '/outputs/FBA_photon_0_WR4_C1-C2_maintX10.txt']);
printFluxes(model, sol.x,true,'',[root '/outputs/FBA_photon_0_WR4_C1-C2_toSampl_maintX10.txt']);
...
sol=solveLP(model,1);
printFluxes(model,sol.x, true)
printFluxes(model, sol.x,false,'',[root '/outputs/FBA_photon_0_WR1_C2-C3_maintX10.txt']);
printFluxes(model, sol.x,true,'',[root '/outputs/FBA_photon_0_WR1_C2-C3_toSampl_maintX10.txt']);
...
sol=solveLP(model,1);
printFluxes(model,sol.x, true)
printFluxes(model, sol.x,false,'',[root '/outputs/FBA_photon_0_WR2_C2-C3_maintX10.txt']);
printFluxes(model, sol.x,true,'',[root '/outputs/FBA_photon_0_WR2_C2-C3_toSampl_maintX10.txt']);
...
sol=solveLP(model,1);
printFluxes(model,sol.x, true)
printFluxes(model, sol.x,false,'',[root '/outputs/FBA_photon_0_WR3_C2-C3_maintX10.txt']);
printFluxes(model, sol.x,true,'',[root '/outputs/FBA_photon_0_WR3_C2-C3_toSampl_maintX10.txt']);
...
sol=solveLP(model,1);
printFluxes(model,sol.x, true)
printFluxes(model, sol.x,false,'',[root '/outputs/FBA_photon_0_WR4_C2-C3_maintX10.txt']);
printFluxes(model, sol.x,true,'',[root '/outputs/FBA_photon_0_WR4_C2-C3_toSampl_maintX10.txt']);
...
sol=solveLP(model,1);
printFluxes(model,sol.x, true)
printFluxes(model, sol.x,false,'',[root '/outputs/FBA_photon_0_WR1_C1-C2_MaintX01.txt']); % 01 refers to 0.1
printFluxes(model, sol.x,true,'',[root '/outputs/FBA_photon_0_WR1_C1-C2_toSampl_MaintX01.txt']); % 01 refers to 0.1
...
sol=solveLP(model,1);
printFluxes(model,sol.x, true)
printFluxes(model, sol.x,false,'',[root '/outputs/FBA_photon_0_WR2_C1-C2_MaintX01.txt']); % 01 refers to 0.1
printFluxes(model, sol.x,true,'',[root '/outputs/FBA_photon_0_WR2_C1-C2_toSampl_MaintX01.txt']); % 01 refers to 0.1
...
sol=solveLP(model,1);
printFluxes(model,sol.x, true)
printFluxes(model, sol.x,false,'',[root '/outputs/FBA_photon_0_WR3_C1-C2_MaintX01.txt']); % 01 refers to 0.1
printFluxes(model, sol.x,true,'',[root '/outputs/FBA_photon_0_WR3_C1-C2_toSampl_MaintX01.txt']); % 01 refers to 0.1
...
sol=solveLP(model,1);
printFluxes(model,sol.x, true)
printFluxes(model, sol.x,false,'',[root '/outputs/FBA_photon_0_WR4_C1-C2_MaintX01.txt']); % 01 refers to 0.1
printFluxes(model, sol.x,true,'',[root '/outputs/FBA_photon_0_WR4_C1-C2_toSampl_MaintX01.txt']); % 01 refers to 0.1
...
sol=solveLP(model,1);
printFluxes(model,sol.x, true)
printFluxes(model, sol.x,false,'',[root '/outputs/FBA_photon_0_WR1_C2-C3_MaintX01.txt']); % 01 refers to 0.1
printFluxes(model, sol.x,true,'',[root '/outputs/FBA_photon_0_WR1_C2-C3_toSampl_MaintX01.txt']); % 01 refers to 0.1
...
sol=solveLP(model,1);
printFluxes(model,sol.x, true)
printFluxes(model, sol.x,false,'',[root '/outputs/FBA_photon_0_WR2_C2-C3_MaintX01.txt']); % 01 refers to 0.1
printFluxes(model, sol.x,true,'',[root '/outputs/FBA_photon_0_WR2_C2-C3_toSampl_MaintX01.txt']); % 01 refers to 0.1
...
sol=solveLP(model,1);
printFluxes(model,sol.x, true)
printFluxes(model, sol.x,false,'',[root '/outputs/FBA_photon_0_WR3_C2-C3_MaintX01.txt']); % 01 refers to 0.1
printFluxes(model, sol.x,true,'',[root '/outputs/FBA_photon_0_WR3_C2-C3_toSampl_MaintX01.txt']); % 01 refers to 0.1
...
sol=solveLP(model,1);
printFluxes(model,sol.x, true)
printFluxes(model, sol.x,false,'',[root '/outputs/FBA_photon_0_WR4_C2-C3_MaintX01.txt']); % 01 refers to 0.1
printFluxes(model, sol.x,true,'',[root '/outputs/FBA_photon_0_WR4_C2-C3_toSampl_MaintX01.txt']); % 01 refers to 0.1
...
sol=solveLP(model,1);
printFluxes(model,sol.x, true)
printFluxes(model, sol.x,false,'',[root '/outputs/FBA_photon_0_WR1_C1-C2_maintX2.txt']);
printFluxes(model, sol.x,true,'',[root '/outputs/FBA_photon_0_WR1_C1-C2_toSampl_maintX2.txt']);
...
sol=solveLP(model,1);
printFluxes(model,sol.x, true)
printFluxes(model, sol.x,false,'',[root '/outputs/FBA_photon_0_WR2_C1-C2_maintX2.txt']);
printFluxes(model, sol.x,true,'',[root '/outputs/FBA_photon_0_WR2_C1-C2_toSampl_maintX2.txt']);
...
sol=solveLP(model,1);
printFluxes(model,sol.x, true)
printFluxes(model, sol.x,false,'',[root '/outputs/FBA_photon_0_WR3_C1-C2_maintX2.txt']);
printFluxes(model, sol.x,true,'',[root '/outputs/FBA_photon_0_WR3_C1-C2_toSampl_maintX2.txt']);
...
sol=solveLP(model,1);
printFluxes(model,sol.x, true)
printFluxes(model, sol.x,false,'',[root '/outputs/FBA_photon_0_WR4_C1-C2_maintX2.txt']);
printFluxes(model, sol.x,true,'',[root '/outputs/FBA_photon_0_WR4_C1-C2_toSampl_maintX2.txt']);
...
sol=solveLP(model,1);
printFluxes(model,sol.x, true)
printFluxes(model, sol.x,false,'',[root '/outputs/FBA_photon_0_WR1_C2-C3_maintX2.txt']);
printFluxes(model, sol.x,true,'',[root '/outputs/FBA_photon_0_WR1_C2-C3_toSampl_maintX2.txt']);
...
sol=solveLP(model,1);
printFluxes(model,sol.x, true)
printFluxes(model, sol.x,false,'',[root '/outputs/FBA_photon_0_WR2_C2-C3_maintX2.txt']);
printFluxes(model, sol.x,true,'',[root '/outputs/FBA_photon_0_WR2_C2-C3_toSampl_maintX2.txt']);
...
sol=solveLP(model,1);
printFluxes(model,sol.x, true)
printFluxes(model, sol.x,false,'',[root '/outputs/FBA_photon_0_WR3_C2-C3_maintX2.txt']);
printFluxes(model, sol.x,true,'',[root '/outputs/FBA_photon_0_WR3_C2-C3_toSampl_maintX2.txt']);
...
sol=solveLP(model,1);
printFluxes(model,sol.x, true)
printFluxes(model, sol.x,false,'',[root '/outputs/FBA_photon_0_WR4_C2-C3_maintX2.txt']);
printFluxes(model, sol.x,true,'',[root '/outputs/FBA_photon_0_WR4_C2-C3_toSampl_maintX2.txt']);
...
sol=solveLP(model,1);
printFluxes(model,sol.x, true)
printFluxes(model, sol.x,false,'',[root '/outputs/FBA_photon_0_WR1_C1-C2_maintX05.txt']);
printFluxes(model, sol.x,true,'',[root '/outputs/FBA_photon_0_WR1_C1-C2_toSampl_maintX05.txt']);
...
sol=solveLP(model,1);
printFluxes(model,sol.x, true)
printFluxes(model, sol.x,false,'',[root '/outputs/FBA_photon_0_WR2_C1-C2_maintX05.txt']);
printFluxes(model, sol.x,true,'',[root '/outputs/FBA_photon_0_WR2_C1-C2_toSampl_maintX05.txt']);
...
sol=solveLP(model,1);
printFluxes(model,sol.x, true)
printFluxes(model, sol.x,false,'',[root '/outputs/FBA_photon_0_WR3_C1-C2_maintX05.txt']);
printFluxes(model, sol.x,true,'',[root '/outputs/FBA_photon_0_WR3_C1-C2_toSampl_maintX05.txt']);
...
sol=solveLP(model,1);
printFluxes(model,sol.x, true)
printFluxes(model, sol.x,false,'',[root '/outputs/FBA_photon_0_WR4_C1-C2_maintX05.txt']);
printFluxes(model, sol.x,true,'',[root '/outputs/FBA_photon_0_WR4_C1-C2_toSampl_maintX05.txt']);
...
sol=solveLP(model,1);
printFluxes(model,sol.x, true)
printFluxes(model, sol.x,false,'',[root '/outputs/FBA_photon_0_WR1_C2-C3_maintX05.txt']);
printFluxes(model, sol.x,true,'',[root '/outputs/FBA_photon_0_WR1_C2-C3_toSampl_maintX05.txt']);
...
sol=solveLP(model,1);
printFluxes(model,sol.x, true)
printFluxes(model, sol.x,false,'',[root '/outputs/FBA_photon_0_WR2_C2-C3_maintX05.txt']);
printFluxes(model, sol.x,true,'',[root '/outputs/FBA_photon_0_WR2_C2-C3_toSampl_maintX05.txt']);
...
sol=solveLP(model,1);
printFluxes(model,sol.x, true)
printFluxes(model, sol.x,false,'',[root '/outputs/FBA_photon_0_WR3_C2-C3_maintX05.txt']);
printFluxes(model, sol.x,true,'',[root '/outputs/FBA_photon_0_WR3_C2-C3_toSampl_maintX05.txt']);
...
sol=solveLP(model,1);
printFluxes(model,sol.x, true)
printFluxes(model, sol.x,false,'',[root '/outputs/FBA_photon_0_WR4_C2-C3_maintX05.txt']);
printFluxes(model, sol.x,true,'',[root '/outputs/FBA_photon_0_WR4_C2-C3_toSampl_maintX05.txt']);
...
sol=solveLP(model,1);
printFluxes(model,sol.x, true)
printFluxes(model, sol.x,false,'',[root '/outputs/FBA_photon_0_WR1_C1-C2_maintX5.txt']);
printFluxes(model, sol.x,true,'',[root '/outputs/FBA_photon_0_WR1_C1-C2_toSampl_maintX5.txt']);
...
sol=solveLP(model,1);
printFluxes(model,sol.x, true)
printFluxes(model, sol.x,false,'',[root '/outputs/FBA_photon_0_WR2_C1-C2_maintX5.txt']);
printFluxes(model, sol.x,true,'',[root '/outputs/FBA_photon_0_WR2_C1-C2_toSampl_maintX5.txt']);
...
sol=solveLP(model,1);
printFluxes(model,sol.x, true)
printFluxes(model, sol.x,false,'',[root '/outputs/FBA_photon_0_WR3_C1-C2_maintX5.txt']);
printFluxes(model, sol.x,true,'',[root '/outputs/FBA_photon_0_WR3_C1-C2_toSampl_maintX5.txt']);
...
sol=solveLP(model,1);
printFluxes(model,sol.x, true)
printFluxes(model, sol.x,false,'',[root '/outputs/FBA_photon_0_WR4_C1-C2_maintX5.txt']);
printFluxes(model, sol.x,true,'',[root '/outputs/FBA_photon_0_WR4_C1-C2_toSampl_maintX5.txt']);
...
sol=solveLP(model,1);
printFluxes(model,sol.x, true)
printFluxes(model, sol.x,false,'',[root '/outputs/FBA_photon_0_WR1_C2-C3_maintX5.txt']);
printFluxes(model, sol.x,true,'',[root '/outputs/FBA_photon_0_WR1_C2-C3_toSampl_maintX5.txt']);
...
sol=solveLP(model,1);
printFluxes(model,sol.x, true)
printFluxes(model, sol.x,false,'',[root '/outputs/FBA_photon_0_WR2_C2-C3_maintX5.txt']);
printFluxes(model, sol.x,true,'',[root '/outputs/FBA_photon_0_WR2_C2-C3_toSampl_maintX5.txt']);
...
sol=solveLP(model,1);
printFluxes(model,sol.x, true)
printFluxes(model, sol.x,false,'',[root '/outputs/FBA_photon_0_WR3_C2-C3_maintX5.txt']);
printFluxes(model, sol.x,true,'',[root '/outputs/FBA_photon_0_WR3_C2-C3_toSampl_maintX5.txt']);
...
sol=solveLP(model,1);
printFluxes(model,sol.x, true)
printFluxes(model, sol.x,false,'',[root '/outputs/FBA_photon_0_WR4_C2-C3_maintX5.txt']);
printFluxes(model, sol.x,true,'',[root '/outputs/FBA_photon_0_WR4_C2-C3_toSampl_maintX5.txt']);
...
sol=solveLP(model,1);
printFluxes(model,sol.x, true)
printFluxes(model, sol.x,false,'',[root '/outputs/FBA_photon_0_WR1_C1-C2_maintX02.txt']);
printFluxes(model, sol.x,true,'',[root '/outputs/FBA_photon_0_WR1_C1-C2_toSampl_maintX02.txt']);
...
sol=solveLP(model,1);
printFluxes(model,sol.x, true)
printFluxes(model, sol.x,false,'',[root '/outputs/FBA_photon_0_WR2_C1-C2_maintX02.txt']);
printFluxes(model, sol.x,true,'',[root '/outputs/FBA_photon_0_WR2_C1-C2_toSampl_maintX02.txt']);
...
sol=solveLP(model,1);
printFluxes(model,sol.x, true)
printFluxes(model, sol.x,false,'',[root '/outputs/FBA_photon_0_WR3_C1-C2_maintX02.txt']);
printFluxes(model, sol.x,true,'',[root '/outputs/FBA_photon_0_WR3_C1-C2_toSampl_maintX02.txt']);
...
sol=solveLP(model,1);
printFluxes(model,sol.x, true)
printFluxes(model, sol.x,false,'',[root '/outputs/FBA_photon_0_WR4_C1-C2_maintX02.txt']);
printFluxes(model, sol.x,true,'',[root '/outputs/FBA_photon_0_WR4_C1-C2_toSampl_maintX02.txt']);
...
sol=solveLP(model,1);
printFluxes(model,sol.x, true)
printFluxes(model, sol.x,false,'',[root '/outputs/FBA_photon_0_WR1_C2-C3_maintX02.txt']);
printFluxes(model, sol.x,true,'',[root '/outputs/FBA_photon_0_WR1_C2-C3_toSampl_maintX02.txt']);
...
sol=solveLP(model,1);
printFluxes(model,sol.x, true)
printFluxes(model, sol.x,false,'',[root '/outputs/FBA_photon_0_WR2_C2-C3_maintX02.txt']);
printFluxes(model, sol.x,true,'',[root '/outputs/FBA_photon_0_WR2_C2-C3_toSampl_maintX02.txt']);
...
sol=solveLP(model,1);
printFluxes(model,sol.x, true)
printFluxes(model, sol.x,false,'',[root '/outputs/FBA_photon_0_WR3_C2-C3_maintX02.txt']);
printFluxes(model, sol.x,true,'',[root '/outputs/FBA_photon_0_WR3_C2-C3_toSampl_maintX02.txt']);
...
sol=solveLP(model,1);
printFluxes(model,sol.x, true)
printFluxes(model, sol.x,false,'',[root '/outputs/FBA_photon_0_WR4_C2-C3_maintX02.txt']);
printFluxes(model, sol.x,true,'',[root '/outputs/FBA_photon_0_WR4_C2-C3_toSampl_maintX02.txt']);
